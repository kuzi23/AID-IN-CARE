...
<html lang="zxx">
    <head>
		...
		<title>Toothst - Dental Clinic And Medical HTML Template</title>
    </head>
					...
					<div class="col-lg-6 col-md-6 ps-0">
						<div class="sign-up-form">
							...
							<form class="form-wrap">
								...
								<p class="already">Already have an account? <a href="index.php">Sign In</a></p>
